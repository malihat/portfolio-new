    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-10">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-center">
        <div className="border border-gray-500 radius-md rounded-xl shadow p-4 flex flex-col items-center">
          <img src={Code} id="skill-icon" className="object-contain mb-2"/>
        ...
        <div className="border border-gray-500 radius-md rounded-xl shadow p-4 flex flex-col items-center">
          <img src={Framework} id="skill-icon" className="object-contain mb-2" />
        ...
        <div className="border border-gray-500 radius-md rounded-xl shadow p-4 flex flex-col items-center">
          <img src={Version} id="skill-icon" className="object-contain mb-2" />
        ...
        <div className="border border-gray-500 radius-md rounded-xl shadow p-4 flex flex-col items-center">
          <img src={Design} id="skill-icon" className="object-contain mb-2" />
